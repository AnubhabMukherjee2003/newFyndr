...
async function like(req, res, next) {
    try {
        const result = await interactionsService.like(req.user.userId, req.params.targetId);
        res.json(result);
    }
    catch (e) {
        next(e);
...
async function pass(req, res, next) {
    try {
        const result = await interactionsService.pass(req.user.userId, req.params.targetId);
        res.json(result);
    }
    catch (e) {
        next(e);
