...
async function executeScenario() {
    ...
    await prisma_1.prisma.interaction.deleteMany({});
    await prisma_1.prisma.user.deleteMany({ where: { email: { not: "admin@test.com" } } });
    await prisma_1.prisma.roleSchema.deleteMany({});
    // 2. Admin Login
...
const server = app_1.default.listen(4000, async () => {
    try {
